...
public class DisxBlankDisc extends Item{
    ...
    public static void registerItem(Registrar<Item> itemRegistry, RegistrySupplier<CreativeModeTab> tab){
        RegistrySupplier<Item> newItem = itemRegistry.register(new ResourceLocation("disx", "blank_disc"), () -> new DisxBlankDisc(new Item.Properties().stacksTo(64).arch$tab(tab)));
    }
}
