...
import mozilla.javascript.ast.ArrayComprehension;
import mozilla.javascript.ast.ArrayComprehensionLoop;
import mozilla.javascript.ast.ArrayLiteral;
import mozilla.javascript.ast.Assignment;
import mozilla.javascript.ast.AstNode;
import mozilla.javascript.ast.AstRoot;
import mozilla.javascript.ast.BigIntLiteral;
import mozilla.javascript.ast.Block;
import mozilla.javascript.ast.BreakStatement;
import mozilla.javascript.ast.CatchClause;
import mozilla.javascript.ast.Comment;
import mozilla.javascript.ast.ConditionalExpression;
import mozilla.javascript.ast.ContinueStatement;
import mozilla.javascript.ast.DestructuringForm;
import mozilla.javascript.ast.DoLoop;
import mozilla.javascript.ast.ElementGet;
import mozilla.javascript.ast.EmptyExpression;
import mozilla.javascript.ast.EmptyStatement;
import mozilla.javascript.ast.ErrorNode;
import mozilla.javascript.ast.ExpressionStatement;
import mozilla.javascript.ast.ForInLoop;
import mozilla.javascript.ast.ForLoop;
import mozilla.javascript.ast.FunctionCall;
import mozilla.javascript.ast.FunctionNode;
import mozilla.javascript.ast.GeneratorExpression;
import mozilla.javascript.ast.GeneratorExpressionLoop;
import mozilla.javascript.ast.IdeErrorReporter;
import mozilla.javascript.ast.IfStatement;
import mozilla.javascript.ast.InfixExpression;
import mozilla.javascript.ast.Jump;
import mozilla.javascript.ast.KeywordLiteral;
import mozilla.javascript.ast.Label;
import mozilla.javascript.ast.LabeledStatement;
import mozilla.javascript.ast.LetNode;
import mozilla.javascript.ast.Loop;
import mozilla.javascript.ast.Name;
import mozilla.javascript.ast.NewExpression;
import mozilla.javascript.ast.NumberLiteral;
import mozilla.javascript.ast.ObjectLiteral;
import mozilla.javascript.ast.ObjectProperty;
import mozilla.javascript.ast.ParenthesizedExpression;
import mozilla.javascript.ast.PropertyGet;
import mozilla.javascript.ast.RegExpLiteral;
import mozilla.javascript.ast.ReturnStatement;
import mozilla.javascript.ast.Scope;
import mozilla.javascript.ast.ScriptNode;
import mozilla.javascript.ast.StringLiteral;
import mozilla.javascript.ast.SwitchCase;
import mozilla.javascript.ast.SwitchStatement;
import mozilla.javascript.ast.Symbol;
import mozilla.javascript.ast.TaggedTemplateLiteral;
import mozilla.javascript.ast.TemplateCharacters;
import mozilla.javascript.ast.TemplateLiteral;
import mozilla.javascript.ast.ThrowStatement;
import mozilla.javascript.ast.TryStatement;
import mozilla.javascript.ast.UnaryExpression;
import mozilla.javascript.ast.UpdateExpression;
import mozilla.javascript.ast.VariableDeclaration;
import mozilla.javascript.ast.VariableInitializer;
import mozilla.javascript.ast.WhileLoop;
import mozilla.javascript.ast.WithStatement;
import mozilla.javascript.ast.XmlDotQuery;
import mozilla.javascript.ast.XmlElemRef;
import mozilla.javascript.ast.XmlExpression;
import mozilla.javascript.ast.XmlLiteral;
import mozilla.javascript.ast.XmlMemberGet;
import mozilla.javascript.ast.XmlPropRef;
import mozilla.javascript.ast.XmlRef;
import mozilla.javascript.ast.XmlString;
import mozilla.javascript.ast.Yield;
