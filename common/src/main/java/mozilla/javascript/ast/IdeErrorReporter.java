...
import mozilla.javascript.ErrorReporter;

/**
 * This is interface defines a protocol for the reporting of errors during JavaScript translation in
 * IDE-mode. If the {@link mozilla.javascript.Parser}'s error reporter is set to an instance of
 * this interface, then this interface's {@link #warning} and {@link #error} methods are called
 * instead of the {@link mozilla.javascript.ErrorReporter} versions.
 *
...
public interface IdeErrorReporter extends ErrorReporter {
     ...
     * Report an error.
     *
     * <p>The implementing class is free to throw an exception if it desires.
     *
