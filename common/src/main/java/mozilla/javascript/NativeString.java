...
import static mozilla.javascript.ScriptRuntime.rangeError;
import static mozilla.javascript.ScriptRuntimeES6.requireObjectCoercible;

import java.text.Collator;
import java.text.Normalizer;
import java.util.Locale;
import mozilla.javascript.ScriptRuntime.StringIdOrIndex;
import mozilla.javascript.regexp.NativeRegExp;
