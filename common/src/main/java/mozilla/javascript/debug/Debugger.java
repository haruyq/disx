...
package mozilla.javascript.debug;
...
public interface Debugger {
     ...
     *
     * @return implementation of DebugFrame which receives debug information during the function or
     *     script execution or null otherwise
     */
