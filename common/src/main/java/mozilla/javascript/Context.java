...
import mozilla.classfile.ClassFileWriter.ClassFileFormatException;
import mozilla.javascript.ast.AstRoot;
import mozilla.javascript.ast.ScriptNode;
import mozilla.javascript.debug.DebuggableScript;
import mozilla.javascript.debug.Debugger;
...
public class Context implements Closeable {
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    @Deprecated
    public static void addContextListener(ContextListener listener) {
        // Special workaround for the debugger
        String DBG = "mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull("mozilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    @Deprecated
     ...
     *
     * @see mozilla.javascript.ErrorReporter
     */
     ...
     * @see mozilla.javascript.SecurityController
     */
    ...
    public Object resumeContinuation(Object continuation, Scriptable scope, Object functionResult)
        ...
        return Interpreter.restartContinuation(
                (mozilla.javascript.NativeContinuation) continuation, this, scope, args);
    }
    ...
    private static Class<?> codegenClass =
            Kit.classOrNull("mozilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass =
            Kit.classOrNull("mozilla.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy() {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull("mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
