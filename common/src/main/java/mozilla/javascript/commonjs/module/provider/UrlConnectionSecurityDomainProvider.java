...
package mozilla.javascript.commonjs.module.provider;
 ...
 * {@link Context#compileReader(java.io.Reader, String, int, Object)}, in {@link Context}) based on
 * the properties obtainable through their URL connection.
 *
 * @author Attila Szegedi
 * @version $Id: UrlConnectionSecurityDomainProvider.java,v 1.3 2011/04/07 20:26:12 hannes%helma.at
 *     Exp $
 */
public interface UrlConnectionSecurityDomainProvider {
     ...
     * @return the security domain object for the script source. Can be null if no security domain
     *     object can be created, although it is advisable for the implementations to be able to
     *     create a security domain object for any URL connection.
     */
