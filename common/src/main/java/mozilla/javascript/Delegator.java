...
public class Delegator implements Function, SymbolScriptable {
     ...
     *
     * @see mozilla.javascript.Delegator#construct
     */
    public Delegator() {}
    ...
    /** @see mozilla.javascript.Scriptable#getClassName */
    @Override
    public String getClassName() {
        return getDelegee().getClassName();
    }

    /** @see mozilla.javascript.Scriptable#get(String, Scriptable) */
    @Override
    ...
    /** @see mozilla.javascript.Scriptable#get(int, Scriptable) */
    @Override
    ...
    /** @see mozilla.javascript.Scriptable#has(int, Scriptable) */
    @Override
    ...
    /** @see mozilla.javascript.SymbolScriptable#put(Symbol, Scriptable, Object) */
    @Override
    ...
    /** @see mozilla.javascript.Scriptable#put(int, Scriptable, Object) */
    @Override
    public void put(int index, Scriptable start, Object value) {
        getDelegee().put(index, start, value);
    }

    /** @see mozilla.javascript.Scriptable#delete(String) */
    @Override
    ...
    /** @see mozilla.javascript.Scriptable#delete(int) */
    @Override
    public void delete(int index) {
        getDelegee().delete(index);
    }

    /** @see mozilla.javascript.Scriptable#getPrototype */
    @Override
    public Scriptable getPrototype() {
        return getDelegee().getPrototype();
    }

    /** @see mozilla.javascript.Scriptable#setPrototype */
    @Override
    public void setPrototype(Scriptable prototype) {
        getDelegee().setPrototype(prototype);
    }

    /** @see mozilla.javascript.Scriptable#getParentScope */
    @Override
    public Scriptable getParentScope() {
        return getDelegee().getParentScope();
    }

    /** @see mozilla.javascript.Scriptable#setParentScope */
    @Override
    public void setParentScope(Scriptable parent) {
        getDelegee().setParentScope(parent);
    }

    /** @see mozilla.javascript.Scriptable#getIds */
    @Override
     ...
     * @see mozilla.javascript.Scriptable#getDefaultValue
     */
    @Override
    ...
    /** @see mozilla.javascript.Scriptable#hasInstance */
    @Override
    public boolean hasInstance(Scriptable instance) {
        return getDelegee().hasInstance(instance);
    }

    /** @see mozilla.javascript.Function#call */
    @Override
