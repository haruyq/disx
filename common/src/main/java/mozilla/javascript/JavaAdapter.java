...
public final class JavaAdapter implements IdFunctionCall {
    ...
    public static byte[] createAdapterCode(
        ...
        cfw.addField(
                "factory",
                "Lmozilla/javascript/ContextFactory;",
    ...
    private static void generateCtor(
        ...
        if (parameters.length == 0) {
            cfw.startMethod(
                    "<init>",
                    "(Lmozilla/javascript/Scriptable;"
                            + "Lmozilla/javascript/ContextFactory;)V",
        ...
        cfw.add(ByteCode.PUTFIELD, adapterName, "delegee", "Lmozilla/javascript/Scriptable;");
        ...
        cfw.addInvoke(
                ...
                "mozilla/javascript/JavaAdapter",
                "createAdapterWrapper",
                "(Lmozilla/javascript/Scriptable;"
                        + "Ljava/lang/Object;"
                        + ")Lmozilla/javascript/Scriptable;");
        cfw.add(ByteCode.PUTFIELD, adapterName, "self", "Lmozilla/javascript/Scriptable;");
    ...
    private static void generateEmptyCtor(
        ...
        cfw.addInvoke(
                ...
                "mozilla/javascript/JavaAdapter",
                "runScript",
                "(Lmozilla/javascript/Script;" + ")Lmozilla/javascript/Scriptable;");
    ...
    private static void generateMethod(
        ...
        // push factory
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "factory", "Lmozilla/javascript/ContextFactory;");

        // push self
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "self", "Lmozilla/javascript/Scriptable;");

        // push function
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "delegee", "Lmozilla/javascript/Scriptable;");
