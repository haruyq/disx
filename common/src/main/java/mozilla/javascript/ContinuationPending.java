...
/**
 * Exception thrown by {@link mozilla.javascript.Context#executeScriptWithContinuations(Script,
 * Scriptable)} and {@link mozilla.javascript.Context#callFunctionWithContinuations(Callable,
 * Scriptable, Object[])} when execution encounters a continuation captured by {@link
 * mozilla.javascript.Context#captureContinuation()}. Exception will contain the captured state
 * needed to restart the continuation with {@link
 * mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 *
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)} and {@link
     * mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
