...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lmozilla/javascript/NativeFunction;"
                        + "Lmozilla/javascript/Context;"
                        + "Lmozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
                        + "Z"
        ...
        addOptRuntimeInvoke(
                ...
                "(Lmozilla/javascript/NativeFunction;"
                        + "Lmozilla/javascript/Scriptable;"
                        + "Lmozilla/javascript/Scriptable;II"
                        + ")Lmozilla/javascript/Scriptable;");
    ...
    private void generateActivationExit() {
        ...
        cfw.addALoad(contextLocal);
        addScriptRuntimeInvoke("exitActivationFunction", "(Lmozilla/javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW, "mozilla/javascript/JavaScriptException");
        ...
        cfw.addInvoke(
                ByteCode.INVOKESPECIAL,
                "mozilla/javascript/JavaScriptException",
                "<init>",
            ...
            case Token.ADD:
                {
                    ...
                    switch (node.getIntProp(Node.ISNUMBER_PROP, -1)) {
                        ...
                        case Node.LEFT:
                            ...
                            addOptRuntimeInvoke(
                                    "add",
                                    "(DLjava/lang/Object;Lmozilla/javascript/Context;)Ljava/lang/Object;");
                            break;
                        case Node.RIGHT:
                            cfw.addALoad(contextLocal);
                            addOptRuntimeInvoke(
                                    "add",
                                    "(Ljava/lang/Object;DLmozilla/javascript/Context;)Ljava/lang/Object;");
                            break;
                        default:
                            cfw.addALoad(contextLocal);
                            addScriptRuntimeInvoke(
    ...
    private void generateYieldPoint(Node node, boolean exprContext) {
        if (unnestedYields.containsKey(node)) {
            ...
            if (exprContext) {
                ...
                addScriptRuntimeInvoke(
                        "getObjectPropNoWarn",
                        "(Ljava/lang/Object;Ljava/lang/String;Lmozilla/javascript/Context;"
                                + "Lmozilla/javascript/Scriptable;)Ljava/lang/Object;");
            }
            return;
        }
        ...
        if (nestedYield != null) {
            ...
            addScriptRuntimeInvoke(
                    "setObjectProp",
                    "(Lmozilla/javascript/Scriptable;Ljava/lang/String;Ljava/lang/Object;"
                            + "Lmozilla/javascript/Context;)Ljava/lang/Object;");
            cfw.add(ByteCode.POP);
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext) {
        ...
        if (node.getType() == Token.YIELD_STAR) {
            ...
            cfw.add(ByteCode.NEW, "mozilla/javascript/ES6Generator$YieldStarResult");
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(
                    ByteCode.INVOKESPECIAL,
                    "mozilla/javascript/ES6Generator$YieldStarResult",
                    "<init>",
                    "(Ljava/lang/Object;)V");
        }
    ...
    private void generateFunctionAndThisObj(Node node, Node parent) {
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lmozilla/javascript/Context;" + ")Lmozilla/javascript/Scriptable;");
    }
    ...
    private static String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "mozilla/javascript/EcmaError";
    ...
    private void addInstructionCount(int count) {
        cfw.addALoad(contextLocal);
        cfw.addPush(count);
        addScriptRuntimeInvoke("addInstructionCount", "(Lmozilla/javascript/Context;" + "I)V");
    }
    ...
    private void visitDotQuery(Node node, Node child) {
        ...
        addScriptRuntimeInvoke(
                "updateDotQuery",
                "(Z" + "Lmozilla/javascript/Scriptable;" + ")Ljava/lang/Object;");
        cfw.add(ByteCode.DUP);
        ...
        addScriptRuntimeInvoke(
                "leaveDotQuery",
                "(Lmozilla/javascript/Scriptable;" + ")Lmozilla/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
    }
