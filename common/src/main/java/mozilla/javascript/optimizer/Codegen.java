...
package mozilla.javascript.optimizer;

import static mozilla.classfile.ClassFileWriter.ACC_FINAL;
import static mozilla.classfile.ClassFileWriter.ACC_PRIVATE;
import static mozilla.classfile.ClassFileWriter.ACC_PROTECTED;
import static mozilla.classfile.ClassFileWriter.ACC_PUBLIC;
import static mozilla.classfile.ClassFileWriter.ACC_STATIC;
import static mozilla.classfile.ClassFileWriter.ACC_VOLATILE;
...
import mozilla.javascript.CompilerEnvirons;
import mozilla.javascript.Context;
import mozilla.javascript.Evaluator;
import mozilla.javascript.Function;
import mozilla.javascript.GeneratedClassLoader;
import mozilla.javascript.Kit;
import mozilla.javascript.NativeFunction;
import mozilla.javascript.ObjArray;
import mozilla.javascript.ObjToIntMap;
import mozilla.javascript.RhinoException;
import mozilla.javascript.Script;
import mozilla.javascript.Scriptable;
import mozilla.javascript.SecurityController;
import mozilla.javascript.Token;
...
public class Codegen implements Evaluator {
    ...
    public Object compile(
        ...
        String mainClassName = "mozilla.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource) {
        ...
        if (hasScript) {
            cfw.addInterface("mozilla/javascript/Script");
    ...
    private void emitDirectConstructor(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        */
        ...
        cfw.addInvoke(
                ...
                "mozilla/javascript/BaseFunction",
                "createObject",
                "(Lmozilla/javascript/Context;"
                        + "Lmozilla/javascript/Scriptable;"
                        + ")Lmozilla/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw, boolean isStrictMode) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKESTATIC,
                "mozilla/javascript/ScriptRuntime",
                "hasTopCall",
                "(Lmozilla/javascript/Context;" + ")Z");
    ...
    private void generateMain(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                mainMethodClass,
                "main",
                "(Lmozilla/javascript/Script;[Ljava/lang/String;)V");
    ...
    private void generateFunctionInit(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKEVIRTUAL,
                "mozilla/javascript/NativeFunction",
                "initScriptFunction",
                "(Lmozilla/javascript/Context;" + "Lmozilla/javascript/Scriptable;" + ")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                "mozilla/javascript/ScriptRuntime",
                "checkRegExpProxy",
                "(Lmozilla/javascript/Context;" + ")Lmozilla/javascript/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(
                        ...
                        "mozilla/javascript/RegExpProxy",
                        "compileRegExp",
                        "(Lmozilla/javascript/Context;"
    ...
    void pushNumberAsObject(ClassFileWriter cfw, double num) {
        if (num == 0.0) {
            ...
            cfw.add(
                    ByteCode.GETSTATIC,
                    "mozilla/javascript/optimizer/OptRuntime",
                    "oneObj",
                    "Ljava/lang/Double;");
            return;
    ...
    static final String DEFAULT_MAIN_METHOD_CLASS = "mozilla.javascript.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME = "mozilla.javascript.NativeFunction";

    static final String ID_FIELD_NAME = "_id";

    static final String REGEXP_INIT_METHOD_NAME = "_reInit";
    static final String REGEXP_INIT_METHOD_SIGNATURE = "(Lmozilla/javascript/Context;)V";
    ...
    static final String FUNCTION_CONSTRUCTOR_SIGNATURE =
            "(Lmozilla/javascript/Scriptable;" + "Lmozilla/javascript/Context;I)V";
