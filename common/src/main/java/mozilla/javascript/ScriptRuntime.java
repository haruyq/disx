...
import mozilla.javascript.v8dtoa.DoubleConversion;
import mozilla.javascript.v8dtoa.FastDtoa;
import mozilla.javascript.xml.XMLLib;
import mozilla.javascript.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public static final Class<?> ContextClass = Kit.classOrNull("mozilla.javascript.Context"),
            ContextFactoryClass = Kit.classOrNull("mozilla.javascript.ContextFactory"),
            FunctionClass = Kit.classOrNull("mozilla.javascript.Function"),
            ScriptableObjectClass = Kit.classOrNull("mozilla.javascript.ScriptableObject");
    ...
    public static ScriptableObject initSafeStandardObjects(
        ...
        new LazilyLoadedCtor(
                scope, "RegExp", "mozilla.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(
                scope, "Continuation", "mozilla.javascript.NativeContinuation", sealed, true);
        ...
        if (((cx.getLanguageVersion() >= Context.VERSION_1_8)
            ...
            new LazilyLoadedCtor(
                    scope,
                    "ArrayBuffer",
                    "mozilla.javascript.typedarrays.NativeArrayBuffer",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Int8Array",
                    "mozilla.javascript.typedarrays.NativeInt8Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Uint8Array",
                    "mozilla.javascript.typedarrays.NativeUint8Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Uint8ClampedArray",
                    "mozilla.javascript.typedarrays.NativeUint8ClampedArray",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Int16Array",
                    "mozilla.javascript.typedarrays.NativeInt16Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Uint16Array",
                    "mozilla.javascript.typedarrays.NativeUint16Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Int32Array",
                    "mozilla.javascript.typedarrays.NativeInt32Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Uint32Array",
                    "mozilla.javascript.typedarrays.NativeUint32Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Float32Array",
                    "mozilla.javascript.typedarrays.NativeFloat32Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "Float64Array",
                    "mozilla.javascript.typedarrays.NativeFloat64Array",
                    sealed,
                    true);
            new LazilyLoadedCtor(
                    scope,
                    "DataView",
                    "mozilla.javascript.typedarrays.NativeDataView",
                    sealed,
                    true);
        }
    ...
    public static ScriptableObject initStandardObjects(
        ...
        new LazilyLoadedCtor(
                s, "Packages", "mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(
                s, "getClass", "mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "JavaAdapter", "mozilla.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(
                s, "JavaImporter", "mozilla.javascript.ImporterTopLevel", sealed, true);

        for (String packageName : getTopPackageNames()) {
            new LazilyLoadedCtor(
                    s, packageName, "mozilla.javascript.NativeJavaTopPackage", sealed, true);
        }
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "mozilla.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String messageId, Object[] arguments) {
            /*
            final String defaultResource = "mozilla.javascript.resources.Messages";
