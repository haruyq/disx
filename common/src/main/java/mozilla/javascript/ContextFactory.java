...
public class ContextFactory {
    ...
    /**
     * Provides a default {@link mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory} to be
     ...
     */
    protected mozilla.javascript.xml.XMLLib.Factory getE4xImplementationFactory() {
        ...
        if (isDom3Present()) {
            return mozilla.javascript.xml.XMLLib.Factory.create(
                    "mozilla.javascript.xmlimpl.XMLLibImpl");
        }
        return null;
    }
