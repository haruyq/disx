...
import static mozilla.javascript.UniqueTag.DOUBLE_MARK;
...
import mozilla.javascript.ScriptRuntime.NoSuchMethodShim;
import mozilla.javascript.ast.FunctionNode;
import mozilla.javascript.ast.ScriptNode;
import mozilla.javascript.debug.DebugFrame;
...
public final class Interpreter extends Icode implements Evaluator {
    ...
    public String getPatchedStack(RhinoException ex, String nativeStackTrace) {
        String tag = "mozilla.javascript.Interpreter.interpretLoop";
