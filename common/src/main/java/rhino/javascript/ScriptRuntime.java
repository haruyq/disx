...
import rhino.javascript.typedarrays.NativeArrayBuffer;
import rhino.javascript.typedarrays.NativeDataView;
import rhino.javascript.typedarrays.NativeFloat32Array;
import rhino.javascript.typedarrays.NativeFloat64Array;
import rhino.javascript.typedarrays.NativeInt16Array;
import rhino.javascript.typedarrays.NativeInt32Array;
import rhino.javascript.typedarrays.NativeInt8Array;
import rhino.javascript.typedarrays.NativeUint16Array;
import rhino.javascript.typedarrays.NativeUint32Array;
import rhino.javascript.typedarrays.NativeUint8Array;
import rhino.javascript.typedarrays.NativeUint8ClampedArray;
import rhino.javascript.v8dtoa.DoubleConversion;
import rhino.javascript.v8dtoa.FastDtoa;
import rhino.javascript.xml.XMLLib;
import rhino.javascript.xml.XMLLoader;
import rhino.javascript.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public static final Class<?> ContextClass = Kit.classOrNull("rhino.javascript.Context"),
            ContextFactoryClass = Kit.classOrNull("rhino.javascript.ContextFactory"),
            FunctionClass = Kit.classOrNull("rhino.javascript.Function"),
            ScriptableObjectClass = Kit.classOrNull("rhino.javascript.ScriptableObject");
    ...
    public static ScriptableObject initSafeStandardObjects(
        ...
        new LazilyLoadedCtor(
                scope, "Continuation", "rhino.javascript.NativeContinuation", sealed, true);
    ...
    public static ScriptableObject initStandardObjects(
        ...
        new LazilyLoadedCtor(
                s, "Packages", "rhino.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(
                s, "getClass", "rhino.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "JavaAdapter", "rhino.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(
                s, "JavaImporter", "rhino.javascript.ImporterTopLevel", sealed, true);

        for (String packageName : getTopPackageNames()) {
            new LazilyLoadedCtor(
                    s, packageName, "rhino.javascript.NativeJavaTopPackage", sealed, true);
        }
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "rhino.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource = "rhino.javascript.resources.Messages";
