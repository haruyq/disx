...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lrhino/javascript/NativeFunction;"
                        + "Lrhino/javascript/Context;"
                        + "Lrhino/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
                        + "Z"
        ...
        addOptRuntimeInvoke(
                ...
                "(Lrhino/javascript/NativeFunction;"
                        + "Lrhino/javascript/Scriptable;"
                        + "Lrhino/javascript/Scriptable;II"
                        + ")Lrhino/javascript/Scriptable;");
    ...
    private void generatePrologue() {
        ...
        if (fnCurrent != null) {
            ...
            if (!isArrow) {
                ...
                cfw.addALoad(variableObjectLocal);
                cfw.add(ByteCode.INSTANCEOF, "rhino/javascript/NativeCall");
                cfw.add(ByteCode.IFEQ, putNull);

                cfw.addALoad(variableObjectLocal);
                cfw.add(ByteCode.CHECKCAST, "rhino/javascript/NativeCall");
                cfw.addInvoke(
                        ByteCode.INVOKEVIRTUAL,
                        "rhino/javascript/NativeCall",
                        "getHomeObject",
                        "()Lrhino/javascript/Scriptable;");
    ...
    private void generateActivationExit() {
        ...
        cfw.addALoad(contextLocal);
        addScriptRuntimeInvoke("exitActivationFunction", "(Lrhino/javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW, "rhino/javascript/JavaScriptException");
        ...
        cfw.addInvoke(
                ByteCode.INVOKESPECIAL,
                "rhino/javascript/JavaScriptException",
                "<init>",
        ...
        switch (type) {
            ...
            case Token.ADD:
                {
                    ...
                    switch (node.getIntProp(Node.ISNUMBER_PROP, -1)) {
                        ...
                        case Node.LEFT:
                            ...
                            addOptRuntimeInvoke(
                                    "add",
                                    "(DLjava/lang/Object;Lrhino/javascript/Context;)Ljava/lang/Object;");
                            break;
                        case Node.RIGHT:
                            cfw.addALoad(contextLocal);
                            addOptRuntimeInvoke(
                                    "add",
                                    "(Ljava/lang/Object;DLrhino/javascript/Context;)Ljava/lang/Object;");
                            break;
                        default:
                            cfw.addALoad(contextLocal);
            ...
            case Token.GET_REF:
                ...
                if (node.getIntProp(Node.OPTIONAL_CHAINING, 0) == 1) {
                    ...
                    cfw.add(ByteCode.CHECKCAST, "rhino/javascript/Ref");
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext) {
        ...
        if (node.getType() == Token.YIELD_STAR) {
            ...
            cfw.add(ByteCode.NEW, "rhino/javascript/ES6Generator$YieldStarResult");
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(
                    ByteCode.INVOKESPECIAL,
                    "rhino/javascript/ES6Generator$YieldStarResult",
                    "<init>",
                    "(Ljava/lang/Object;)V");
        }
    ...
    private void visitFunction(OptFunctionNode ofn, int functionType) {
        ...
        if (ofn.fnode.isMethodDefinition()) {
            ...
            cfw.addInvoke(
                    ...
                    "rhino/javascript/BaseFunction",
                    "setHomeObject",
                    "(Lrhino/javascript/Scriptable;)V");
        }
    ...
    private void visitObjectLiteral(Node node, Node child, boolean topLevel) {
        ...
        cfw.addInvoke(
                ...
                "newObject",
                "(Lrhino/javascript/Scriptable;)Lrhino/javascript/Scriptable;");
        cfw.add(ByteCode.DUP);
    ...
    private void visitStandardCall(Node node, Node child) {
        ...
        if (node.getIntProp(Node.SUPER_PROPERTY_ACCESS, 0) == 1) {
            ...
            if (isOptionalChainingCall) {
                ...
                cfw.markLabel(doCallLabel);
                cfw.add(ByteCode.CHECKCAST, "rhino/javascript/Callable");
            }
    ...
    private void pushThisFromLastScriptable() {
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lrhino/javascript/Context;" + ")Lrhino/javascript/Scriptable;");
    }
    ...
    private static String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "rhino/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "rhino/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "rhino/javascript/EcmaError";
    ...
    private void addInstructionCount(int count) {
        cfw.addALoad(contextLocal);
        cfw.addPush(count);
        addScriptRuntimeInvoke("addInstructionCount", "(Lrhino/javascript/Context;" + "I)V");
    }
    ...
    private void visitDotQuery(Node node, Node child) {
        ...
        addScriptRuntimeInvoke(
                "updateDotQuery",
                "(Z" + "Lrhino/javascript/Scriptable;" + ")Ljava/lang/Object;");
        cfw.add(ByteCode.DUP);
