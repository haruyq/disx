...
public class Delegator implements Function, SymbolScriptable {
     ...
     *
     * @see rhino.javascript.Delegator#construct
     */
    public Delegator() {}
    ...
    /**
     * @see rhino.javascript.Scriptable#getClassName
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#get(String, Scriptable)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#get(int, Scriptable)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#has(int, Scriptable)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.SymbolScriptable#put(Symbol, Scriptable, Object)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#put(int, Scriptable, Object)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#delete(String)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#delete(int)
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#getPrototype
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#setPrototype
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#getParentScope
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#setParentScope
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#getIds
     */
    @Override
     ...
     * @see rhino.javascript.Scriptable#getDefaultValue
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Scriptable#hasInstance
     */
    @Override
    ...
    /**
     * @see rhino.javascript.Function#call
     */
    @Override
