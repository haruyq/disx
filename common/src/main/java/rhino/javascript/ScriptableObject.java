...
import rhino.javascript.ScriptRuntime.StringIdOrIndex;
import rhino.javascript.annotations.JSConstructor;
import rhino.javascript.annotations.JSFunction;
import rhino.javascript.annotations.JSGetter;
import rhino.javascript.annotations.JSSetter;
import rhino.javascript.annotations.JSStaticFunction;
import rhino.javascript.debug.DebuggableObject;
 ...
 *
 * @see rhino.javascript.Scriptable
 * @author Norris Boyd
 */
public abstract class ScriptableObject extends SlotMapOwner
     ...
     *
     * @see rhino.javascript.ScriptableObject#getAttributes(String)
     * @see rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see rhino.javascript.ScriptableObject #put(String, Scriptable, Object)
     * @see rhino.javascript.ScriptableObject#getAttributes(String)
     * @see rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see rhino.javascript.ScriptableObject#getIds()
     * @see rhino.javascript.ScriptableObject#getAttributes(String)
     * @see rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see rhino.javascript.ScriptableObject#delete(String)
     * @see rhino.javascript.ScriptableObject#getAttributes(String)
     * @see rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see rhino.javascript.ScriptableObject#has(String, Scriptable)
     * @see rhino.javascript.ScriptableObject#READONLY
     * @see rhino.javascript.ScriptableObject#DONTENUM
     * @see rhino.javascript.ScriptableObject#PERMANENT
     * @see rhino.javascript.ScriptableObject#EMPTY
     */
     ...
     * @exception EvaluatorException if the named property is not found
     * @see rhino.javascript.Scriptable#has(String, Scriptable)
     * @see rhino.javascript.ScriptableObject#READONLY
     * @see rhino.javascript.ScriptableObject#DONTENUM
     * @see rhino.javascript.ScriptableObject#PERMANENT
     * @see rhino.javascript.ScriptableObject#EMPTY
     ...
     *     the named class
     * @see rhino.javascript.Function
     * @see rhino.javascript.FunctionObject
     * @see rhino.javascript.ScriptableObject#READONLY
     * @see rhino.javascript.ScriptableObject #defineProperty(String, Class, int)
     */
     ...
     * @see rhino.javascript.Scriptable#put(String, Scriptable, Object)
     */
