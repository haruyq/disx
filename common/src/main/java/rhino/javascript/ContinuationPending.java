...
/**
 * Exception thrown by {@link rhino.javascript.Context#executeScriptWithContinuations(Script,
 * Scriptable)} and {@link rhino.javascript.Context#callFunctionWithContinuations(Callable,
 * Scriptable, Object[])} when execution encounters a continuation captured by {@link
 * rhino.javascript.Context#captureContinuation()}. Exception will contain the captured state
 * needed to restart the continuation with {@link
 * rhino.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 *
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * rhino.javascript.Context#executeScriptWithContinuations(Script, Scriptable)} and {@link
     * rhino.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
