...
import rhino.classfile.ClassFileWriter.ClassFileFormatException;
import rhino.javascript.ast.AstRoot;
import rhino.javascript.ast.ScriptNode;
import rhino.javascript.debug.DebuggableScript;
import rhino.javascript.debug.Debugger;
...
public class Context implements Closeable {
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(rhino.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    @Deprecated
    public static void addContextListener(ContextListener listener) {
        // Special workaround for the debugger
        String DBG = "rhino.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull("rhino.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(rhino.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    @Deprecated
     ...
     *
     * @see rhino.javascript.ErrorReporter
     */
     ...
     * @see rhino.javascript.SecurityController
     */
    ...
    public Object resumeContinuation(Object continuation, Scriptable scope, Object functionResult)
        ...
        return Interpreter.restartContinuation(
                (rhino.javascript.NativeContinuation) continuation, this, scope, args);
    }
    ...
    private static Class<?> codegenClass =
            Kit.classOrNull("rhino.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass =
            Kit.classOrNull("rhino.javascript.Interpreter");
