...
public final class JavaAdapter implements IdFunctionCall {
    ...
    public static byte[] createAdapterCode(
        ...
        cfw.addField(
                "factory",
                "Lrhino/javascript/ContextFactory;",
    ...
    private static void generateCtor(
        ...
        if (parameters.length == 0) {
            cfw.startMethod(
                    "<init>",
                    "(Lrhino/javascript/Scriptable;"
                            + "Lrhino/javascript/ContextFactory;)V",
        ...
        cfw.add(ByteCode.PUTFIELD, adapterName, "delegee", "Lrhino/javascript/Scriptable;");
        ...
        cfw.addInvoke(
                ...
                "rhino/javascript/JavaAdapter",
                "createAdapterWrapper",
                "(Lrhino/javascript/Scriptable;"
                        + "Ljava/lang/Object;"
                        + ")Lrhino/javascript/Scriptable;");
        cfw.add(ByteCode.PUTFIELD, adapterName, "self", "Lrhino/javascript/Scriptable;");
    ...
    private static void generateEmptyCtor(
        ...
        cfw.addInvoke(
                ...
                "rhino/javascript/JavaAdapter",
                "runScript",
                "(Lrhino/javascript/Script;" + ")Lrhino/javascript/Scriptable;");
    ...
    private static void generateMethod(
        ...
        // push factory
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "factory", "Lrhino/javascript/ContextFactory;");

        // push self
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "self", "Lrhino/javascript/Scriptable;");

        // push function
        cfw.add(ByteCode.ALOAD_0);
        cfw.add(ByteCode.GETFIELD, genName, "delegee", "Lrhino/javascript/Scriptable;");
