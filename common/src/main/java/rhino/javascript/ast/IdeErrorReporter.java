...
import rhino.javascript.ErrorReporter;

/**
 * This is interface defines a protocol for the reporting of errors during JavaScript translation in
 * IDE-mode. If the {@link rhino.javascript.Parser}'s error reporter is set to an instance of
 * this interface, then this interface's {@link #warning} and {@link #error} methods are called
 * instead of the {@link rhino.javascript.ErrorReporter} versions.
 *
