...
import static rhino.javascript.UniqueTag.DOUBLE_MARK;
...
import rhino.javascript.ScriptRuntime.NoSuchMethodShim;
import rhino.javascript.ast.FunctionNode;
import rhino.javascript.ast.ScriptNode;
import rhino.javascript.debug.DebugFrame;
...
public final class Interpreter extends Icode implements Evaluator {
    ...
    public String getPatchedStack(RhinoException ex, String nativeStackTrace) {
        String tag = "rhino.javascript.Interpreter.interpretLoop";
